...
function msg_handler($errno, $msg_text, $errfile, $errline)
{
	...
	switch ($errno)
	{
		...
		case E_USER_ERROR:
			...
			echo '		Powered by <a href="https://bitnami.com/stack/phpbb">Bitnami phpBB Stack</a> &copy; phpBB Limited';
			echo '	</div>';
			echo '</div>';
			echo '</body>';
			echo '</html>';
...
function page_header($page_title = '', $display_online_list = false, $item_id = 0, $item = 'forum', $send_headers = true)
{
	...
	*/
	...
	$template->assign_vars(array(
		...
		'U_SEARCH_LATEST'		=> append_sid("{$phpbb_root_path}search.$phpEx", 'search_id=latestposts&amp;sr=posts'),
...
function page_footer($run_cron = true, $display_template = true, $exit_handler = true)
{
	...
	*/
	...
	$template->assign_vars(array(
		...
		'CREDIT_LINE'			=> $user->lang('POWERED_BY', '<a href="https://bitnami.com/stack/phpbb">Bitnami phpBB Stack</a> &copy; phpBB Limited'),
